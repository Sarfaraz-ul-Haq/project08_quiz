...
const answers = await inquirer.prompt([
  {
    ...
    message: chalk.green(
      "Nextjs is a framework built on top of which library?"
    ),
  },
  {
    name: "q2",
    ...
    message: chalk.green(
      "What is one of the primary benefits of using Nextjs for building web applications?  "
    ),
  },
  {
    name: "q3",
    ...
    message: chalk.green(
      "Which of the following Nextjs components helps optimize images in your application? "
    ),
  },
  {
    name: "q4",
    ...
    choices: ["True", "False"],
    message: chalk.green(
      "True or False: Nextjs applications can be statically generated, meaning the HTML is pre-rendered at build time for faster initial page loads"
    ),
  },
  {
    name: "q5",
    ...
    message: chalk.green(
      "What is the purpose of the getStaticProps function in Nextjs?"
    ),
  },
  {
    name: "q6",
    ...
    message: chalk.green(
      "What is the difference between static generation and server-side rendering (SSR) in Nextjs? "
    ),
  },
  {
    name: "q7",
    ...
    message: chalk.green(
      "Which statement best describes the use of TypeScript with Nextjs?"
    ),
  },
  {
    name: "q8",
    ...
    message: chalk.green(
      "Which of the following is NOT a valid way to create a custom 404 page in Nextjs?    "
    ),
  },
  {
    name: "q9",
  ...
  },
  {
    ...
    message: chalk.green(
      "What are some advantages of using Nextjs compared to vanilla React when building web applications?"
    ),
  },
]);
